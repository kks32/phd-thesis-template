...
\begin{table}
    ...
    \begin{tabular}{c p{2cm} p{2cm}}
        ...
        \hline
    \end{tabular}
    \caption[Current values used to model scintillator emission from electrons in \SI{2.2}{\gpl} LABPPO.]{Current values used to model scintillator emission from electrons in \SI{2.2}{\gpl} LABPPO~\cite{latorreNewMeasurementsTiming2016,hunt-stokesEmissionTimingTuning2022}.}
...
\begin{figure}
    ...
    \caption[The current modelled distribution for the emission timing of the SNO+ scintillator]{The current modelled distribution for the emission timing of the SNO+ scintillator, for electron tracks~\cite{latorreNewMeasurementsTiming2016,hunt-stokesEmissionTimingTuning2022}.%
    }
...
\begin{figure}
    ...
    {Comparison of the SNO+ liquid scintillator cocktail's absorption and emission properties, with/without BisMSB~\cite{kaptanogluOpticsOverviewProposed2016,kaptanogluDocumentationAttenuationStudies2022}. % cite optics?
    }
...
One can show that the differential cross-section associated with Rayleigh scattering of unpolarised light off of a single particle, $\frac{d^{2}\sigma_{\textrm{Ray}}}{d\theta d\phi}\left(\theta,\phi\right)$, is given by~\cite{jacksonSection10Scattering1998}: % cite something that gets rayleigh scattering formula
\begin{equation}
...
\begin{figure}
    ...
    \caption[Example charge spectra for a PMT as a function of the true npe generated]{Example charge spectra for a PMT as a function of the true npe generated~\cite{dungerOccupancyAnalysisMultipleHit2016}. % cite whom?
    }
