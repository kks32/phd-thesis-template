...
\nomenclature{\textbf{AmBe}}{Americium-Beryllium radioative source}
Another critical component of the detector to calibrate well is the energy response: given a specific amount of energy deposited in the water/scintillator, how many hits are observed? For this, a number of radioactive sources are used at a variety of energies. In the scintillator phase, there have been three main sources. The first is an americium-beryllium (AmBe) source, which generates a coincidence pair of gamma rays, the prompt at \SI{4.4}{\MeV}, and delayed at \SI{2.2}{\MeV}. The 
Because these gammas are emitted in coincidence, the AmBe source is also useful 
