...
\RequirePackage[labelsep=colon,tableposition=top,font=small,labelfont=bf]{caption}
...
\DeclareSIUnit{\npe}{\text{npe}}
\DeclareSIUnit{\gpl}{\text{g/L}}
\DeclareSIUnit{\dB}{\text{dB}}
\DeclareSIUnit{\Bq}{\text{Bq}}
...
\newcommand{\onbb}{$0\nu\beta\beta$}
\newcommand{\dmsq}{\ensuremath{\Delta m^{2}_{21}}}
\newcommand{\tonetwo}{\ensuremath{\theta_{12}}}
\newcommand{\alphan}{$(\alpha, n)$}
\newcommand{\tres}{\ensuremath{t_{res}}}
