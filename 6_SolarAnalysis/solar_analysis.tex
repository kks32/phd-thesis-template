...
\begin{figure}
    ...
    \caption[]
    {Distributions of the two external classifiers, for both the \beight{} signal and acrylic \ce{^{208}Tl} background. Contours indicate lines of equal probability density. All events shown were not just in the analysis ROI, but also below \SI{5}{\MeV}. Grey regions indicate the cuts used in this analysis.}
