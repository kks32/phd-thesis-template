...
\subsection{Including Oscillations in the Fit}
    ...
    %  \end{itemize}
{
    ...
    \subsection{Dataset and Livetime}
    \begin{itemize}
    ...
    \end{itemize}
    \subsection{Expected Rates and Constraints}
    \begin{itemize}
        \item Show expected rates calculation for both signal and background.
        \item Describe the constraints chosen to apply to the fit, and why they can be justified. These are: B8 flux constraint; U-238 and Th-232 constraints from BiPo tagging; alpha-n constraint from Po-210 tagging; external constraints from Tony Zummo's water-phase externals analysis.
        \item Describe the systematics to be added to the fit (just energy scale for now, maybe also energy smearing?). Mention other systematics that could be of relevance, and then discuss how they should be handled: either scanned over, or have its sub-dominance in this statistics-limited analysis be demonstrated.
    \end{itemize}
    \subsection{Results}
    \begin{itemize}
        ...
        \item Show posterior density plots for each nuisance parameter, to check that they all look sensible and have sufficient statistics.
        \item Show plot of correlation coefficients between parameters, and look at any correlations that are particularly interesting.
    \end{itemize}
    \begin{itemize}
        ...
        \item Discussion of systematics post-fit --- is energy scaling reasonable? Perform a scan over energy smearing, and check impact of possible radial scale systematic.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Describe any further constraints to be assumed on top of the existing analysis of data: expected improved constraints on various backgrounds, as well as a possible energy-scale calibration constraint from the AmBe source, for example.
    ...
    \begin{itemize}
        \item Say what has been achieved with the analysis in this chapter! Both in terms of actual measurement of \tonetwo{}, but also expected sensitivities in the future.
        \item Give suggestions for further work that could be done on this analysis beyond the addition of further livetime:
        \begin{itemize}
