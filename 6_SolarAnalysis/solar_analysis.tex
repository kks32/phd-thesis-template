...
this is shown in Fig.~\ref{fig:solar_data_mc_slices_comparison}. We see that the \beight{} signal distribution only dominates above \SI{5}{\MeV}, as well as at low energies for the first two radial slices. This is because for larger radii, external backgrounds such as the PMT $\beta-\gamma$s, rope \ce{^{208}Tl}, and external water \ce{^{214}Bi} become the dominant processes in the \SIrange{2.5}{2.8}{\MeV} region. Between \SIrange{3}{5}{\MeV}, at all radii the internal \ce{^{208}Tl} shows a clear peak well above the \beight{} signal.

\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{6_SolarAnalysis/images/data_mc_fit_plot_1D_energy_r3_slices_log.pdf}
