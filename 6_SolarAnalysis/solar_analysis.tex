...
In the other, the external water backgrounds were set to the level measured by T. Zummo in the water phase, and the internal \ce{^{208}Tl} were reduced by a factor of 10. This latter scenario reflects the possibility of better control of the radioactivity in the external water, as well as a way of using new analysis methods to cut out 90\% of the internal \ce{^{208}Tl} events.
