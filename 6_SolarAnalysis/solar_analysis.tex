...
and re-coordinated for the \SI{2.2}{\gpl} LABPPO scintillator optics by Ziping Ye~\cite{}. % Ziping's presentation on DocDB
...
previous solar oscillation experiments demonstrate that this assumption is reasonable~\cite{}. % CITE!
For this analysis, the standard MSW effect is assumed with neutrinos obeying the Normal Hierarchy, with the Sun following the \texttt{B16\_GS98} metallicity model~\cite{} % CITE
